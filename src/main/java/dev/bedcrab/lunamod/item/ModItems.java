...
public class ModItems {
    public static final Item MOON_SWORD = registerItem("moon_sword", new MoonSwordItem(MoonToolMaterial.MOON_TOOL_MATERIAL, 5, -2.4f, new FabricItemSettings().maxCount(1).rarity(Rarity.RARE).group(ModItemGroup.MOON_ROCK)));
    public static final Item MOON_PICKAXE = registerItem("moon_pickaxe", new MoonPickaxeItem(MoonToolMaterial.MOON_TOOL_MATERIAL, 6, -2.8f , new FabricItemSettings().maxCount(1).rarity(Rarity.RARE).group(ModItemGroup.MOON_ROCK)));
